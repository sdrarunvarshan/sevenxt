...
class TermsOfServicesScreen extends StatefulWidget {
  ...
  @override
  State<TermsOfServicesScreen> createState() =>
      _TermsOfServicesScreenState();
}

class _TermsOfServicesScreenState
    extends State<TermsOfServicesScreen> {
  String content = '';
  bool isLoading = true;
  ...
  Future<void> _fetchContent() async {
    try {
      ...
      setState(() {
        content = pages['Terms of Service'] ?? 'Content not available';
        isLoading = false;
      });
    } catch (e) {
      setState(() {
