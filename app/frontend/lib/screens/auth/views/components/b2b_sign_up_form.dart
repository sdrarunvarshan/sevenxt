...
class _B2BSignUpState extends State<B2BSignUpForm> {
  ...
  Future<void> _b2bSignUp() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text(response['message'] ?? 'B2B Application Submitted!')),
      );

      Navigator.pushNamedAndRemoveUntil(context, entryPointScreenRoute, (r) => false);
    } catch (e) {
      if (!mounted) return;
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
      ...
      child: Column(
        children: [
          TextFormField(
            ...
            validator: (value) => value != null && value.isNotEmpty ? null : 'Business name is required',
          ),
          ...
          TextFormField(
            ...
            validator: (value) => value != null && value.isNotEmpty ? null : 'GSTIN is required',
          ),
          ...
          TextFormField(
            ...
            validator: (value) => value != null && value.isNotEmpty ? null : 'PAN is required',
          ),
          ...
          TextFormField(
            ...
            validator: (value) => value != null && value.isNotEmpty ? null : 'Phone number is required',
            decoration: InputDecoration(
