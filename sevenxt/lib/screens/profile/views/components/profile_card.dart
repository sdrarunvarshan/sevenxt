...
class ProfileCard extends StatelessWidget {
  const ProfileCard({
    ...
    required this.name,
    required this.email,
    required this.profileImageWidget, // Changed from imageSrc (String)
  ...
  final Widget profileImageWidget; // Changed type to Widget
  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      leading: CircleAvatar(
        radius: 28,
        child: profileImageWidget, // Using the new Widget here
      ),
      title: Row(
        children: [
          Text(
