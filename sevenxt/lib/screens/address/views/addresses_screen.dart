  ...
  factory Address.fromJson(Map<String, dynamic> json) {
    return Address(
      ...
      address: json['address'] ??
          '', // Changed key from 'street' to 'address' and mapped to new field
      city: json['city'] ?? '',
...
class _AddressesScreenState extends State<AddressesScreen> {
  ...
  // ───── Delete Address ─────
  void _deleteAddress(
      String userAddressId, String addressId, bool wasDefault) async {
    try {
      ...
      body: _addresses.isEmpty
          ...
          : Align(
              ...
              child: ConstrainedBox(
                constraints: const BoxConstraints(maxWidth: 900), // 👈 WEB FIX
