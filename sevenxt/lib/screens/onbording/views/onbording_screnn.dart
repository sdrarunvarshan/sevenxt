...
class _OnBordingScreenState extends State<OnBordingScreen> {
  ...
  final List<Onbord> _onbordData = [
    ...
    Onbord(
      ...
      description:
          "In particular, sevenxt can pack your orders, and help you seamlessly manage your shipments.",
    ),
    Onbord(
      image: "assets/Illustration/Illustration-4.png",
      imageDarkTheme: "assets/Illustration/Illustration_darkTheme_4.png",
      title: "Nearby stores",
      description:"Easily track nearby sevenxts, browse through their items and get information about their prodcuts.",
    ),
  ];
              ...
              Align(
                ...
                child: TextButton(
                  onPressed: () async{
                    ...
                    await authBox.put('has_seen_onboarding', true); // NEW
