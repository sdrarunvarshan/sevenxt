...
import 'package:sevenxt/models/review_model.dart';
import 'package:sevenxt/route/api_service.dart';
import 'package:sevenxt/screens/reviews/view/components/review_product_card.dart';
...
class _ProductReviewsScreenState extends State<ProductReviewsScreen> {
  ...
  void _loadAuthUser() {
    ...
    final isGuestValue = authBox.get('is_guest');
    _isGuest = isGuestValue == true; // Only true if explicitly set to true
